...
export const socialTrafficData: SocialTrafficType[] = [
  {
    ...
    referral: 'Facebook',
    visitors: '1,480',
    progress: { percentage: 60, indicator: '#ED8936' },
  },
  {
    id: '728ed52f',
    referral: 'Facebook',
    visitors: '5,480',
    progress: { percentage: 70, indicator: '#ED8936' },
  },
  {
    id: '728ed52f',
    referral: 'Google',
    visitors: '4,807',
    progress: { percentage: 80, indicator: '#0BC5EA' },
  },
  {
    id: '728ed52f',
    referral: 'Instagram',
    visitors: '3,678',
    progress: { percentage: 75, indicator: '#0BC5EA' },
  },
  {
    id: '728ed52f',
    referral: 'Facebook',
    visitors: '2,645',
    progress: { percentage: 30, indicator: '#ED8936' },
  },
];
